...
const Cards = ({title, description, date, image, content, onClick}) => {
  return (
    <div onClick={onClick} className='w-[20vw] bg-slate-100 rounded-sm px-4 py-4 mx-4 my-4 flex flex-col gap-3 cursor-pointer hover:scale-105 hover:shadow-[0_14px_12px_5px_rgba(0,0,0,0.3)] transition-all ease-in-out duration-150'>
